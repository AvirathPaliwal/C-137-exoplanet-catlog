...
export default class DetailsScreen extends Component {
     constructor(props) {
          ...
          this.state = {
               details: {},
               imagePath: "",
               url: `http://e133-122-161-87-85.ngrok.io/planet?name=${this.props.navigation.getParam("planet_name")}`
               ...
               return (
                    <View style={styles.container}>
                         <Card
                            ...
                            <Text style={styles.cardItem} >{`Distance from there sun : ${details.distance_from_their_sun}`}</Text>
